...
def generateTrainData(labeledPairs, products):
    ...
    products = {id: vector for id, vector in products.toLocalIterator()}
...
def extractLabeledPairsFromJourney():
    ...
    trainData.saveAsTextFile(joinPath(hdfsOutputFolder, 'iPhone_6_part0_journey_TrainData'))
    print_('iPhone_6_part0_journey_TrainData has been saved successfully')