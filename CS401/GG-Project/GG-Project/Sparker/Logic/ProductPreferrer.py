...
def getLabeledPairsWithModulizedIds(journey):
    ...
    for paidId, pCount in paidCnt:
        ...
        for listedId, listedCount in listedCnt:
             addDominantPair(paidId, listedId)
