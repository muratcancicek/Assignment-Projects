...
def generateTrainData(labeledPairs, products):  #TO DO 
    import pyspark.mllib.feature as py, PythonVersionHandler
    ...
    features =  labeledPairs.map(lambda x: normalizer.transform(products[x[0][0]]) - normalizer.transform(products[x[0][1]]))
