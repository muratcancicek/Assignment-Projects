...
//}
//
//void saveLZW(string fileName, vector<int>* codes)
//{
//	ofstream lzwFile(fileName, ios::binary);
//	int numberOfCodes = codes->size();
//	const double bitsNumber = 9 * 1 / CHAR_BIT;
//	bitset<2> bs(numberOfCodes);
//	lzwFile << bs;
...
//	vector<string>* characters = getCharacters(argc, argv);
//	if (characters == NULL)
//	{
//		return 0; // SERCEN: bir terslik varsa program1 bitir
//	}
//	vector<int>* outputCode = getEncodedOutput(characters);
//	saveLZW(argv[2], outputCode);
//	//system("pause");
//	return 0;
//}