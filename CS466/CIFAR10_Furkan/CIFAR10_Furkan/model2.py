...
import read_data as cifar10_input
...
tf.app.flags.DEFINE_string('data_dir2', '/Users/Furkan/Desktop/tmp/cifar10_data',
...
def _variable_on_cpu(name, shape, initializer):
  ...
  """
    with tf.device('/cpu:0'):
        dtype = tf.float16 if FLAGS.use_fp162 else tf.float32
